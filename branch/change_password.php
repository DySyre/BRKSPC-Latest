    ...
    <title>Change Password</title>
        <body>  
            ...
            ?>
                ...
                <p style="color: red; border: 1px solid #ccc; background-color: #f5f5f5; padding: 10px; width: 300px;"><?php echo $_SESSION['msg1'];?> <?php $_SESSION['msg1'] =""; ?></p>

                <p class="form-control mt-5 mb-8" align="center" style="color: red; border: 1px solid #ccc; background-color: #f5f5f5; padding: 10px; width: 300px; justify-content: center; text-align: center; align-items: center;"><?php echo $_SESSION['msg2'];?> <?php $_SESSION['msg2'] ="";?> </p>
                ...
                <table align="center">
                        <tr height="50">
                            <td>Email ID:</td>
                            <td><input class="form-control" type="text" name="useremail" id="useremail" required></td>
                        </tr>
                        <tr height="50">
                            <td>Old Password:</td>
                        ...
                        <tr height="50">
                            <td>New Password:</td>
                            <td><input class="form-control" type="password" name="npwd" id="npwd" required></td>
                        </tr>
                        <tr height="50">
                        ...
                        <tr height="50">
                            <td><a href="branch.php" id="bth" class="form-control" style="text-decoration: none;">Back to home</a></td>
