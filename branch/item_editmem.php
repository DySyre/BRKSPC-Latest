    ...
    <div class="row">
        ...
        <div class="row">
              ...
              <div class="col-md-12">
                   <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="eItemName" id="classroom_name" required value="<?php echo $row['item_name'] ?>" >
              ...
              <div class="col-md-12">
                   <div class="form-group">
                      <label style="font-size: 1rem;" for="fname">Item Category</label>
                       <select class="form-control" name="eItemCatId">
                        <option value="<?php echo $row['item_category_id'] ?>" hidden><?php echo $row['item_category_name'].'->'.$row['branch_name'] ?></option>
                      <?php
                      $queryBranch = "SELECT * FROM `item_category_tbl` JOIN branch_tbl ON item_category_tbl.item_category_branch = branch_tbl.branch_id where item_category_branch ='$branchId'";
                ...
                <div class="col-md-12">
                   <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="eBuyingName" id="" required placeholder="" step="0.01" pattern="[0-9]+(\.[0-9]+)?" value="<?php echo $row['item_buying_price'] ?>" >
               ...
               <div class="col-md-12">
                   <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="eSellingName" id="" required placeholder="" step="0.01" pattern="[0-9]+(\.[0-9]+)?" value="<?php echo $row['item_selling_price'] ?>" >
              ...
              <div class="col-md-12">
                   <div class="form-group">
                     ...
                     <input type="date" class="form-control" name="eExpirationName" id="classroom_name"  placeholder="" value="<?php echo $row['item_expiration']; ?>" >
     ...
     <div class="modal-footer">
      ...
      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
       <button type="submit" data-id='<?php echo $row['item_id']; ?>'  class="btn btn-primary">Save</button> 
       </div>                
