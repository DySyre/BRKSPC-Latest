...
$output= array();
$sql = "SELECT * FROM `pos_purchase_his_tbl` JOIN item_tbl on pos_purchase_his_tbl.pos_purchase_hisitemidfk = item_tbl.item_id JOIN item_category_tbl ON item_tbl.item_categoryidfk = item_category_tbl.item_category_id join branch_tbl ON item_category_tbl.item_category_branch = branch_tbl.branch_id where isProceed = '1' and branch_id ='$branchId'";
