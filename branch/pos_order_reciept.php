...
$CheckSbranchId = "SELECT * FROM `branch_tbl`  WHERE branch_id = '$branchId'";
$reCheckSbranchId = mysqli_query($con, $CheckSbranchId);
$rowreCheckSbranchId = mysqli_fetch_assoc($reCheckSbranchId);
$branName = $rowreCheckSbranchId['branch_name'];
 ...
 <head>
  ...
  <div class="col-md-10">
    <label style="font-weight: bold;">BRANCH: <?php echo $branName ?> </label><br>
