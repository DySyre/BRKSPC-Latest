...
const fontSizeSelect = document.getElementById('font-size-select');
  ...
  popupWin.document.write('<html><head><title></title><style type="text/css">\
    ...
    </style></head><br><br><center><h3>Barkspace Pet Grooming And Wellness Center</h3><h4>INVENTORY SUMMARY</h4></center><body>' + printContents + '</body></html>');
