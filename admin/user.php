        ...
        <div class="container" style="margin-left: 220px;">
            ...
            <div class="container-fluid">
                  <div class="input-group">
                     ...
                     <a href="#!" data-id="" data-bs-toggle="modal" data-bs-target="#addStaffModal" class="btn btn-primary btn-sm me-md-2">ADD USER</a>
                </div>
      ...
      <div class="modal-content">
        ...
        <div class="row row0-5">
              ...
              <div class="col-md-12">
               ...
               <div class="col-md-12">
                   <div class="form-group">
                      <label style="font-size: 1rem;" for="fname">User Type</label>
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="form-group" id="email">
                      ...
                      <input type="email" class="form-control" name="email" id="emaall"  required placeholder="">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group" id="password">
                      <label style="font-size: 1rem;" for="fname">Password</label>
                      <input type="password" class="form-control" name="pass"  id="passy" min="8"  required placeholder="">
                    </div>
                  </div>
          </div>
...
<!-- modal -->
  <!-- <script src="./js/bootstrap.bundle.min.js"></script> -->
   ...
   success: function(data) {
            ...
            mytable.draw();
              swal("Succes", "User Added", "success");
             ...
             swal("Error", "User Already Exist", "error");
              ...
              swal("Error", "User Added Error", "error");
            }
          }
...
.then((willDelete) => {
    ...
    $.ajax({
          ...
          success: function(data) {
            ...
            if (status == 'success') {
              mytable = $('#tabledataStaff').DataTable();
            mytable.draw();
               swal("Succes","User has been deleted!", {
      icon: "success",
    });
  ...
  $('#tabledataStaff').on('click', '.editbtnClassroom', function(event) {
   ...
   $(document).ready(function() {
  // Hide the "Email" and "Password" inputs initially
  $('#email, #password').hide();

  // Attach an event listener to the "User Type" dropdown
  $('select[name="userType"]').change(function() {
    // Get the selected value
    var selectedValue = $(this).val();

    // If "Staff" is selected, hide the "Email" and "Password" inputs; otherwise, show them
    if (selectedValue === '2') {
       document.getElementById("emaall").required = false;
       document.getElementById("passy").required = false;
      $('#email, #password').hide();

    } else {
      document.getElementById("emaall").required = true;
       document.getElementById("passy").required = true;
