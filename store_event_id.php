...
if (isset($_POST['schedIdd'])) {
     $selectPetd = $_POST['selectPetd'];
if($selectPetd == 'newPet')
{ // start if new pet
    // walang pet

  // Sanitize and store the event_id in a session variable
    $even_id = $_POST['schedIdd'];
   $selectPetd = $_POST['selectPetd'];
        ...
        <div class="row">  
            ...
            <div class="col-md-2">
                <div class="form-group">
                 ...
                 <input list="petType1[]" pattern="[A-Za-z]{1,}" class="form-control" required="required">
             ...
             <div class="col-md-3">
                ...
                <input list="text" name="petBreed1[]" class="form-control" pattern="[A-Za-z]{1,}" name="breed1[] ">
...
<!-- howmany pets -->
        ...
        <div class="row">  
 <?php
        $queryPet = "select * from pets where id = '$selectPetd'";
        ...
        while($rowqueryPet = mysqli_fetch_assoc($resqueryPet))
        {
            ...
            <div class="col-md-3">
               <div class="form-group">
                  ...
                  <input type="hidden" class="form-control"  name="userid" value="<?php echo $user_id; ?>">
                    <input type="hidden" name="MypetNa" value="1">
                    <input type="hidden" class="form-control"  name="petid1[]" value = "<?php echo $rowqueryPet['id'] ?>">
                  <input type="text" class="form-control"  name="nchild_name1[]" value="<?php echo $rowqueryPet['pet_name'] ?>" readonly>
                  <input type="hidden" class="form-control"  name="pet1" value="pet1">   
            ...
            <div class="col-md-2">
                <div class="form-group"> 
                 <label for="gender">Gender <label style="color: #435D7D;"></label> <label style="color:red; font-size: 1.2rem;">*</label></label>
                 <input type="text" class="form-control"  name="nchild_kasarian1[]" value="<?php echo $rowqueryPet['pet_gender'] ?>" readonly>
            ...
            <div class="col-md-2">
                <div class="form-group">
                <label for="dob">Date of Birth<label style="color: #435D7D;"></label><label style="color:red; font-size: 1.2rem;">*</label></label>
                <input type="date" class="form-control" name="nchild_birthday1[]" value="<?php echo $rowqueryPet['pet_dob'] ?>" readonly>
              </div>       
            </div>
            ...
            <div class="col-md-2">
                <div class="form-group"> 
                 <label for="gender">Pet Type <label style="color: #435D7D;"></label> <label style="color:red; font-size: 1.2rem;">*</label></label>
                 <input type="text" class="form-control"  name="petType1[]" value="<?php echo $rowqueryPet['pet_type'] ?>" readonly>
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" name="breed1[]" value="<?php echo $rowqueryPet['pet_breed'] ?>" readonly>
              </div>       
            </div>
            <?php
        }
